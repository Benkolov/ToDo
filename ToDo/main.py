...
def render_main_view():
    clear_view()
    Button(tk, text='List all task', bg='blue', fg='white', command=render_list_task_view).grid(column=0, row=0,
                                                                                                padx=20, pady=20)
    Button(tk, text='Create task', bg='green', fg='white', command=render_create_view).grid(column=1, row=0, padx=20,
                                                                                            pady=20)
...
def render_list_task_view():
    ...
    Button(tk, text="Cancel", bg='black', fg='white', command=render_main_view).grid(column=1, row=1)
...
def render_create_view():
    ...
    Button(tk, text='Create task', bg='green', fg='white',
           command=lambda: create_task(task_name.get(),
                                       task_description.get("1.0", END), task_priority.get(),
                                       task_completed.get())).grid(column=0, row=4)
    Button(tk, text="Cancel", bg='black', fg='white', command=render_main_view).grid(column=1, row=4)
